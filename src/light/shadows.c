...
** Last update Sun Jun  8 23:24:16 2014 chambon emmanuel
*/
...
void   	get_light_vector(t_ray *shine, t_ray *ray, t_spot *light, t_rt *rt)
{
  int  	i;
...
colour		shadows(t_rt *rt, t_ray *ray, t_obj *obj)
{
  t_ray		shine;
  t_obj		*obj_list;
  t_spot	*lights;
