/*
** aliasing.c for rt in /home/tran_0/Dropbox/raytracer/chambo_e/link_folder/client
**
** Made by david tran
** Login   <tran_0@epitech.net>
**
** Started on  Sun Jun  8 05:01:16 2014 david tran
** Last update Sun Jun  8 22:59:47 2014 david tran
*/
...
void   	init_alias(t_rt_client *rt, t_ray *ray)
{
  if (!ray || !rt)
    return;
  ray->k = 1e6;
...
void		calc_color_alias(t_rt_client *img, t_ray *ray, t_obj *tmp)
{
  t_obj		*obj_result;
...
int		cast_a_ray_alias(t_rt_client *img, int x, int y)
{
  t_ray		ray;
  t_color	color;
  t_obj		*tmp;
